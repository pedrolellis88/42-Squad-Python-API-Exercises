...
1) exercicio1.py — Informações do Pokémon (PokeAPI)
...
2) exercicio2.py — Progresso dos projetos na 42 (42 Intra API)
...
3) exercicio_bonus.py — Adicionar dados de Pokémon ao Google Sheets
